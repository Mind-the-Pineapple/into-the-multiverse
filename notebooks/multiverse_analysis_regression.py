# -*- coding: utf-8 -*-
"""Script to run the multiverse regression analysis. This was autogenerated from
the jupyter notebook.

Instead of running the notebok this python file can be run. However, take into
account that it mike take about 24hrs to run the entire script.

This script assumes:
1. that the into=the-multiverse github repo
(git clone https://github.com/Mind-the-Pineapple/into-the-multiverse/)
has been already cloned locally.
2. There is a python enviroment with the required packaged installed.
3. That the data has been downloaded into the path into-the-multiverse/data/age.
The data can be downloaded from here:
https://figshare.com/articles/Data_for_Conservative_and_disruptive_modes_of_adolescent_change_in_human_brain_functional_connectivity_/11551602
